...
class MinkLocParams:
    ...
    def __init__(self, params_path, model_params_path):
        ...
        if 'Contrastive' in self.loss:
            ...
            self.pos_pairs_above_threshold = params.getfloat('pos_pairs_above_threshold', 0.1)
            self.neg_pairs_above_threshold = params.getfloat('neg_pairs_above_threshold', 1.4)
