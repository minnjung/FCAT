...
import models.minkfcgf as minkfcgf
#from models.FCGF.resunet import FCGF
...
def model_factory(params):
    ...
    elif 'MinkFCGF' in params.model_params.model:
        model = minkfcgf.MinkFCGF(params.model_params.model, 
                                in_channels=in_channels,
                                feature_size=params.model_params.feature_size,
                                output_dim=params.model_params.output_dim, 
                                planes=params.model_params.planes,
